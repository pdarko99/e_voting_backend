...
var OrgDetails = /** @class */ (function () {
    ...
    OrgDetails.prototype.createCandidate = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var cand, savedCand, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        cand = new candidateModel_1.default(req.body);
    ...
    OrgDetails.prototype.updateCandiate = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var filter, update, updatedData, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
...
//# sourceMappingURL=orgDetailsController.js.map