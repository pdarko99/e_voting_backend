...
var OrgVoters = /** @class */ (function () {
    ...
    OrgVoters.prototype.loginUser = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var data, id, token, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.checkDb(data, id)];
                    case 2:
                        token = _a.sent();
                        if (token.token)
                            return [2 /*return*/, res.status(200).send({ message: "successful", token: token.token })];
                        return [3 /*break*/, 4];
                    case 3:
                        error_7 = _a.sent();
                        next(error_7);
    ...
    OrgVoters.prototype.checkDb = function (data, id) {
        return __awaiter(this, void 0, void 0, function () {
            var loginUser, validPassword, token, user, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, votersModel_1.default.findOne({
